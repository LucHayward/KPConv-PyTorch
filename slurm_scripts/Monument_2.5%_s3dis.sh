...
#SBATCH --job-name="Monument_2.5%-s3dis"
#SBATCH --mail-user=hywluc001@myuct.ac.za
#SBATCH --mail-type=ALL
#SBATCH -e slurm-Monument_2.5%-s3dis.err
#SBATCH -o slurm-Monument_2.5%-s3dis.out
...
cd KPConv-PyTorch
python3 train_Masters.py Monument_2.5% Monument 2.5% s3dis-xyz
