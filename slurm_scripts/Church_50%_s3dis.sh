...
#SBATCH --job-name="Church_50%-s3dis"
#SBATCH --mail-user=hywluc001@myuct.ac.za
#SBATCH --mail-type=ALL
#SBATCH -e slurm-Church_50%-s3dis.err
#SBATCH -o slurm-Church_50%-s3dis.out
...
cd KPConv-PyTorch
python3 train_Masters.py Church_50% Church 50% s3dis-xyz
